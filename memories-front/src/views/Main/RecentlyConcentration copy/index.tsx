...
export default function RecentlyConcentraion() {
  ...
  return (
    // render:  최근 집중력 검사 렌더링 //
    <div className='recently-container'>
      <div className='recently-top'>
        <div className='recently-title-box'>
          <div className='title'>집중력 검사 기록</div>
          <div className='info-button' onClick={onWayClickHandler}>집중력을 높이는 방법 <div className='icon' /></div>
          {isModalOpen &&
        ...
        <div className='button primary middle' onClick={onTestClickHandler}>검사하러 가기</div>
      </div>
