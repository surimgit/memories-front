    ...
    <div id='auth-login-container'>
      <div className='header'>Memories</div>
        <div className='input-container'>
          <InputBox type='text' label={'아이디'} value={userId} placeholder={'아이디를 입력해주세요'}
          message={userIdMessage} isErrorMessage onChange={onUserIdChangeHandler}/>
          <InputBox type='password' label={'비밀번호'} value={userPassword} placeholder='비밀번호를 입력해주세요'
          message={userPasswordMessage} isErrorMessage onChange={onUserPasswordChangeHandler}/>
        </div>
