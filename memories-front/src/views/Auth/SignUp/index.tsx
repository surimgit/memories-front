  ...
  return (
    <div id='auth-sign-up-contanier'>
      ...
      <div className='input-container'>
        ...
        onChange={onUserIdChangeHandler} message={userIdMessage} 
        buttonName={'중복 확인'} onButtonClick={onCheckUserIdClickHandler} isButtonActive={isUserIdCheckButtonActive}/>
        ...
        onChange={onUserAddressChangeHandler} message={userAddressMessage} 
        buttonName={'주소 검색'} onButtonClick={onSearchAddressClickHandler} isErrorMessage isButtonActive readOnly/>

        <InputBox label={'상세 주소'} type='text' value={userDetailaddress} placeholder={'상세주소를 입력해주세요.'}
