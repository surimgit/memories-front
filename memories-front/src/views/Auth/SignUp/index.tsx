...
const issignUpButtonClass = `button ${issignUpButtonActive ? 'primary' : 'disable'} fullwidth`; 
...
const onCheckUserIdClickHandler = () => {
  ...
  const idList = ['qwer1234', 'rewq4321', 'abcd1234'];
  const isExist = idList.includes(userId);
  const message = isExist ? '이미 사용중인 아이디입니다' : '사용가능한 아이디입니다';
  ...
  return (
    <div id='auth-sign-up-container'>
      ...
      <div className='button-container'>
        <div className={issignUpButtonClass} onClick={onSignUpClickHandler}>회원가입</div>
